...
public class UserWeb {
    ...
    @RequestMapping(value = "/dblUser/{userId}", method = RequestMethod.PUT, produces = {"application/json"})
    ...
    @RequestMapping(value = "/upUser/{userId}", method = RequestMethod.PUT, produces = {"application/json"})
